...
public class JsonMapper extends ObjectMapper {
	 ...
	 * @param valueTypeRef 格式：new TypeReference<List<Bean>>() {}
	 * @param <T> 例如：List<Bean>
	 * @return 返回Bean集合
	 */
	public static <T> T fromJsonString(String jsonString, TypeReference<T> valueTypeRef) {
		return JsonMapper.getInstance().fromJson(jsonString, valueTypeRef);
	}
	 ...
	 */
	private JsonMapper enableEnumUseToString() {
	 ...
	 */
	private JsonMapper enableJaxbAnnotation() {
	 ...
	 * 如果JSON字符串为"[]", 返回空集合.
	 * 
	 * 如需反序列化复杂Collection如List<Bean>, 请使用fromJson(String,JavaType)
	 ...
	 * @return 返回Bean集合
	 */
	private <T> T fromJson(String jsonString, TypeReference<T> valueTypeRef) {
		if (StringUtils.isEmpty(jsonString)) {
			return null;
		}
		try {
